  ...
  return (
    <div>
      ...
      <input
        id={id}
        className={cn(
          'w-full px-3 py-2 rounded-lg border border-slate-300 focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition text-sm',
  ...
  return (
    <div>
      ...
      <select
        id={id}
        className={cn(
          'w-full px-3 py-2 rounded-lg border border-slate-300 focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition text-sm bg-white',
          className
        )}
        {...props}
      >
